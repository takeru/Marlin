...
#define STRING_CONFIG_H_AUTHOR "(Lc1975)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KingRoonKP3"
...
#define TOUCH_BUTTONS
  ...
  #define BUTTON_DELAY_MENU 180 // (ms) Button repeat delay for menus
